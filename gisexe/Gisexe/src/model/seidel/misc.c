//#include <triangulate.h> // dd
//#include <sys/time.h>    // dd
#include "triangulate.h"
#include <time.h>
#include <math.h>

//#ifdef __STDC__              // dd
//extern double log2(double);  // dd
//#else                        // dd
//extern double log2();        // dd
//#endif                       // dd
...
int generate_random_ordering(n)
     int n;
{
  //struct timeval tval;          // dd
  //struct timezone tzone;        // dd
  register int i;
  int m, st[SEGSIZE], *p;
  
  choose_idx = 1;
  //gettimeofday(&tval, &tzone);  // dd
  //srand48(tval.tv_sec);         // dd
  srand(time(NULL));                 // dd
